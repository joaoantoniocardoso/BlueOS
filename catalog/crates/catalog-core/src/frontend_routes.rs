...
use catalog_model::journey::{JourneyStep, RouteRef};
use serde::Serialize;
...
mod tests {
    ...
    use crate::catalog::Catalog;
    use catalog_data::backend::services::recorder_extractor::{OBSERVED_FACTS, SERVICE_DEFINITION};
    ...
    use catalog_model::journey::{Actor, HttpMethod, JourneyStep, RouteRef, UseCase, Visibility};
