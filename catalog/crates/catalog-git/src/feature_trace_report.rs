...
use crate::feature_trace_enrich::journey_pickaxe_term;
use catalog_data::feature_trace::{
    commit, discovery_for_journey, feature_traces, intro_commit_for_journey, issue, journey_ref,
    journey_report_trace, pull_request, TracePullRequest,
};
use catalog_kernel::id::journey::JourneyId;
use catalog_kernel::version::{parse_release_tag, BlueOsChannel};
...
pub fn build_timeline(journey_id: &str) -> Option<JourneyTimeline> {
    let trace = journey_report_trace(journey_id)?;
