...
use catalog_model::capability::{CapabilityDef, FrontendCapabilityDef};
...
pub fn is_frontend_capability(capability: &CapabilityId) -> bool {
    frontend_capability_def(*capability).is_some()
}
