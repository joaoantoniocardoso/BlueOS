    ...
    RuntimeFacts {
        ...
        platform_matrix: GroundedSet::known(&[GroundedItem::new(
            PlatformBehavior {
                ...
                firmware: None,
                notes: &[
                    "user_terminal is a platform-independent persistent root shell tmux session",
                    "runtime captured on Navigator only; idle bash pane RSS ~2.5 MB, CPU 0% across 60 samples",
                    "tmux session user_terminal alive since boot; pane PID 1040 runs idle -bash; no HTTP interface",
                ],
            },
            runtime_prov("runtime-captures/user_terminal__pi4_navigator_master.json#platform_matrix"),
        )]),
...
const fn runtime_resource(
    ...
    GroundedItem::new(
        ...
        runtime_prov("runtime-captures/user_terminal__pi4_navigator_master.json#resource_usage"),
    )
}
...
pub const OBSERVED_FACTS: ObservedFacts = ObservedFacts {
    ...
    kind: Observed::known(
        ...
        Evidence {
            ...
            line: 141,
            anchor: "'user_terminal',0,0,0,0,\"cat /etc/motd\"",
        },
    ),
...
pub const SERVICE_DEFINITION: ServiceJudgment =
    ServiceJudgment {
        ...
        health: Asserted::established(
            "implicit: tmux session liveness; user_terminal tmux session existence serves as health signal",
        ...
        permissions_model: Asserted::established(
            "no auth layer; direct tmux attach only — not operator-facing without ttyd or SSH",
