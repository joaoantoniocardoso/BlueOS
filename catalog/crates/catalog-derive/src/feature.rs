...
use catalog_analysis::cluster::{greedy_modularity_communities, modularity_q_indices};
use catalog_analysis::split::{clique_weights, consensus_over, group_by_key, modularity_partition};
use catalog_core::catalog::Catalog;
use catalog_data::capability_registry::{capability_def, CAPABILITIES, FRONTEND_CAPABILITIES};
...
use catalog_kernel::provenance::{AssertedSet, GroundedSet, ObservedSet};
...
fn journey_capability_indices(
    journey: &catalog_model::journey::UseCase,
    catalog: &Catalog,
...
mod tests {
    use super::*;
    use catalog_data::capability_registry::FRONTEND_CAPABILITIES;
