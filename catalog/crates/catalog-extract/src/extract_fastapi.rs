...
use catalog_kernel::provenance::{Evidence, Grounded, GroundedItem, GroundedSet, Provenance};
...
pub fn extracted_fastapi_matches_observed(
...
pub fn strip_fastapi_path_converter(path: &str) -> String {
...
pub fn normalized_route_path(path: &str) -> String {
...
pub fn service_dir_for_id(service: ServiceId) -> &'static str {
    match service {
        ServiceId::Wifi => "wifi",
        ServiceId::Ping => "ping",
...
fn journey_steps(
    journey: &UseCase,
) -> Option<&[GroundedItem<catalog_model::journey::JourneyStep>]> {
    match &journey.steps {
...
pub fn evidence_from_fastapi_source(evidence: &Evidence) -> bool {
...
mod tests {
    ...
    fn fastapi_window_is_two_sided() {
        ...
        let observed = RouteRef {
            service: catalog_kernel::id::service::ServiceId::Ping,
