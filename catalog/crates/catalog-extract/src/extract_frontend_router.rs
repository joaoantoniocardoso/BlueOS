...
use catalog_kernel::provenance::{Evidence, Observed};
...
pub fn menu_matches_page_title(page: &Page, menu: &ExtractedFrontendMenu) -> bool {
...
pub fn evidence_from_router(evidence: &Evidence) -> bool {
    evidence.file == ROUTER_INDEX
}

pub fn evidence_from_menus(evidence: &Evidence) -> bool {
...
mod tests {
    ...
    fn synthetic_bridges_page(
        ...
        Page {
            id: catalog_kernel::id::page::PageId::Bridges,
            ...
            stores: catalog_kernel::provenance::ObservedSet::known(&[]),
            consumes: catalog_kernel::provenance::ObservedSet::known(&[]),
            frontend_features: catalog_kernel::provenance::AssertedSet::established(&[]),
            client_state: catalog_kernel::provenance::AssertedSet::established(&[]),
        }
    }
}
