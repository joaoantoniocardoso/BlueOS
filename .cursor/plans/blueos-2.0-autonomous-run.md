...
- Phase 4 progress: FULLY MODELED (20; 18 py + 2 binaries) = ...python18..., mavlink2rest, linux2rest.
- IMAGE NOTE: live Pi master image advanced from sha256:cdccc744 → sha256:0406983a between the mavlink2rest and linux2rest captures (master auto-updates). Each runtime artifact records its own image sha; not a defect. Older artifacts keep cdccc744.
...
- **NEXT UP: `video` (mavlink-camera-manager)** (then zenohd, nginx, ttyd, iperf3, filebrowser, recorder) then user_terminal.
