...
- Phase 4 progress: FULLY MODELED (17) = ardupilot_manager, kraken, disk_usage, helper, commander, beacon, cable_guy, wifi, versionchooser, bag_of_holding, customization, nmea_injector, pardal, ping, bridget.
- **NEXT UP: `recorder_extractor`** (then the ~9 binaries, then user_terminal).
