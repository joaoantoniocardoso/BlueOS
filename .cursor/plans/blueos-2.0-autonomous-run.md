...
- Phase 4 progress: FULLY MODELED (19; 18 py + 1 binary) = ...python18..., mavlink2rest.
...
- **NEXT UP: `linux2rest`** (then video/mavlink-camera-manager, zenohd, nginx, ttyd, iperf3, filebrowser, recorder) then user_terminal.
